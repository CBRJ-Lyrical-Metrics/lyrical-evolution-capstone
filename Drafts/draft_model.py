...
# get the data
df = prepare.model_clean(pd.read_csv("songs_0526.csv", index_col=0))
...
# html_set = set(decades[decades.decade == "HTML"].common_bigrams.values[0])
# python_set = set(decades[decades.decade == "Python"].common_bigrams.values[0])
# r_set = set(decades[decades.decade == "R"].common_bigrams.values[0])
# other_set = set(decades[decades.decade == "Other"].common_bigrams.values[0])
...
# decades["bigrams_unique_to_decade"] = list(unique_to_lang)
